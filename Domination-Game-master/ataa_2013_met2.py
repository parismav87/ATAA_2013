...
# Tournament1.one_on_one(red="domination/agent.py", blue="agents/r2qAgent.py", output_folder='_tmp')

# for x in xrange(1,10000):
# 	print x,"/",10000
# 	Tournament1.test(red="domination/agent.py", blue="runForest.py")

Tournament1.test(red="domination/agent.py", blue="agents/r2qAgent.py")
